...
package starling.text
{
    ...
    internal class MiniBitmapFont 
    {
        ...
        public static function get texture():Texture
        {
            ...
            bitmapData.dispose();
            bitmapData = null;
            internal::texture.root.onRestore = function ():void
            {
                bitmapData = getBitmapData();
                internal::texture.root.uploadBitmapData(bitmapData);
                bitmapData.dispose();
                bitmapData = null;
            };
        ...
        {
            var _local_4:int;
            var _local_1:BitmapData = new BitmapData(128, 64);
            var _local_3:ByteArray = new ByteArray();
            var _local_2:int = BITMAP_DATA.length;
            _local_4 = 0;
            while (_local_4 < _local_2)
            {
                _local_3.writeUnsignedInt(BITMAP_DATA[_local_4]);
                _local_4++;
            };
            _local_3.uncompress();
            _local_1.setPixels(new Rectangle(0, 0, 128, 64), _local_3);
            _local_3.clear();
            return (_local_1);
        }
