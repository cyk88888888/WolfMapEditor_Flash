...
package com.greensock.plugins
{
    ...
    public class HexColorsPlugin extends TweenPlugin 
    {
        ...
        override public function _onInitTween(_arg_1:Object, _arg_2:*, _arg_3:TweenLite):Boolean
        {
            ...
            {
                _initColor(_arg_1, _local_4, _arg_2[_local_4]);
            };
            return (true);
        }
        ...
        public function _initColor(_arg_1:Object, _arg_2:String, _arg_3:uint):void
        {
            ...
            var _local_5:uint;
            _local_8 = (typeof(_arg_1[_arg_2]) == "function");
            var _local_7:uint = ((_local_8) ? _arg_1[(((_arg_2.indexOf("set")) || (!(("get" + _arg_2.substr(3)) in _arg_1))) ? _arg_2 : ("get" + _arg_2.substr(3)))]() : _arg_1[_arg_2]);
            if (_local_7 != _arg_3)
            {
                _local_5 = (_local_7 >> 16);
                var _local_6:uint = ((_local_7 >> 8) & 0xFF);
                var _local_4:uint = (_local_7 & 0xFF);
                _colors[_colors.length] = new ColorProp(_arg_1, _arg_2, _local_8, _local_5, ((_arg_3 >> 16) - _local_5), _local_6, (((_arg_3 >> 8) & 0xFF) - _local_6), _local_4, ((_arg_3 & 0xFF) - _local_4));
        ...
        override public function setRatio(_arg_1:Number):void
        {
            var _local_3:* = null;
            var _local_2:Number;
            var _local_4:int = _colors.length;
            while (--_local_4 > -1)
            {
                _local_3 = _colors[_local_4];
                _local_2 = ((((_local_3.rs + (_arg_1 * _local_3.rc)) << 16) | ((_local_3.gs + (_arg_1 * _local_3.gc)) << 8)) | (_local_3.bs + (_arg_1 * _local_3.bc)));
                if (_local_3.f)
                {
