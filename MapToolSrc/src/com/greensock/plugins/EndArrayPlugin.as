...
package com.greensock.plugins
{
    ...
    public class EndArrayPlugin extends TweenPlugin 
    {
        ...
        public function _init(_arg_1:Array, _arg_2:Array):void
        {
            ...
            while (--_local_4 > -1)
            {
                if (((!(_arg_1[_local_4] == _arg_2[_local_4])) && (!(_arg_1[_local_4] == null))))
                {
                    _info[_local_3++] = new ArrayTweenInfo(_local_4, _a[_local_4], (_arg_2[_local_4] - _a[_local_4]));
                };
            };
        }
        ...
        override public function setRatio(_arg_1:Number):void
        {
            var _local_3:* = null;
            var _local_2:Number;
            var _local_4:int = _info.length;
            if (_round)
            {
                while (--_local_4 > -1)
                {
                    _local_3 = _info[_local_4];
                    _local_2 = ((_local_3.c * _arg_1) + _local_3.s);
                    _a[_local_3.i] = ((_local_2 > 0) ? ((_local_2 + 0.5) >> 0) : ((_local_2 - 0.5) >> 0));
                };
            }
            else
            {
