...
package com.greensock
{
    ...
    public class TimelineLite extends SimpleTimeline 
    {
        ...
        public function TimelineLite(_arg_1:Object=null)
        {
            ...
            {
                _local_3 = this.vars[_local_2];
                if ((_local_3 is Array))
                {
                    if (TweenLite.containsSelf(_local_3))
                    {
                        this.vars[_local_2] = _swapSelfInParams((_local_3 as Array));
                    };
                };
            };
        ...
        public static function exportRoot(_arg_1:Object=null, _arg_2:Boolean=true):TimelineLite
        {
            ...
            _local_6 = new TimelineLite(_arg_1);
            var _local_5:SimpleTimeline = _local_6._timeline;
            _local_5._remove(_local_6, true);
            _local_6._startTime = 0;
            var _local_7:* = _local_5._time;
            _local_6._totalTime = _local_7;
            _local_6._time = _local_7;
            _local_6._rawPrevTime = _local_7;
            var _local_4:Animation = _local_5._first;
            while (_local_4)
            {
                _local_3 = _local_4._next;
                if (((!(_arg_2)) || (!((_local_4 is TweenLite) && (TweenLite(_local_4).target == _local_4.vars.onComplete)))))
                {
                    _local_6.add(_local_4, (_local_4._startTime - _local_4._delay));
                };
                _local_4 = _local_3;
            };
            _local_5.add(_local_6, 0);
            return (_local_6);
        }
        ...
        override public function add(_arg_1:*, _arg_2:*="+=0", _arg_3:String="normal", _arg_4:Number=0):*
        {
            ...
            if (!(_arg_1 is Animation))
            {
                if ((_arg_1 is Array))
                {
                    var _local_5:Number = _arg_2;
                    var _local_9:Number = _arg_1.length;
                    _local_7 = 0;
                    while (_local_7 < _local_9)
                    {
                        ...
                        {
                            _local_10 = new TimelineLite({"tweens":_local_10});
                        };
                        add(_local_10, _local_5);
                        if (!((typeof(_local_10) === "string") || (typeof(_local_10) === "function")))
                        {
                            if (_arg_3 === "sequence")
                            {
                                _local_5 = (_local_10._startTime + (_local_10.totalDuration() / _local_10._timeScale));
                            }
                            else
                            {
                                if (_arg_3 === "start")
                                {
                                    _local_10._startTime = (_local_10._startTime - _local_10.delay());
                                };
                            };
                        };
            ...
            if (((_gc) || (_time === _duration)))
            {
                if (!_paused)
                {
                    ...
                    {
                        _local_6 = this;
                        var _local_8:* = (_local_6.rawTime() > _arg_1._startTime);
                        while (_local_6._timeline)
                        {
                            if (((_local_8) && (_local_6._timeline.smoothChildTiming)))
                            {
                                _local_6.totalTime(_local_6._totalTime, true);
                            }
                            else
                            {
                                if (_local_6._gc)
                                {
                                    _local_6._enabled(true, false);
                                };
                            };
        ...
        {
            return ((_arg_1 in _labels) ? _labels[_arg_1] : -1);
        }
        ...
        protected function _parseTimeOrLabel(_arg_1:*, _arg_2:*=0, _arg_3:Boolean=false, _arg_4:Object=null):Number
        {
            ...
            if (((typeof(_arg_1) === "string") && ((isNaN(_arg_1)) || (_arg_1 in _labels))))
            {
                ...
                if (_local_5 === -1)
                {
                    ...
                    {
                        return ((_arg_3) ? ((_local_6 = (duration() + _arg_2)), (_labels[_arg_1] = _local_6), _local_6) : _arg_2);
                    };
                    return (_labels[_arg_1] + _arg_2);
                };
                _arg_2 = (parseInt((_arg_1.charAt((_local_5 - 1)) + "1"), 10) * _arg_1.substr((_local_5 + 1)));
        ...
        {
            return (totalTime(((typeof(_arg_1) === "number") ? _arg_1 : _parseTimeOrLabel(_arg_1)), _arg_2));
        }
        ...
        override public function render(_arg_1:Number, _arg_2:Boolean=false, _arg_3:Boolean=false):void
        {
            ...
            var _local_8:Number = ((_dirty) ? totalDuration() : _totalDuration);
            var _local_7:Number = _time;
            var _local_4:Number = _startTime;
            var _local_11:Number = _timeScale;
            var _local_6:Boolean = _paused;
            if (_arg_1 >= _local_8)
            {
                _totalTime = (_time = _local_8);
                if (!_reversed)
                {
                    if (!_hasPausedChild())
                    {
            ...
            else
            {
                ...
                {
                    _totalTime = (_time = 0);
                    if (((!(_local_7 === 0)) || (((_duration === 0) && (!(_rawPrevTime === _tinyNum))) && ((_rawPrevTime > 0) || ((_arg_1 < 0) && (_rawPrevTime >= 0))))))
                    {
                        _local_12 = "onReverseComplete";
                        _local_13 = _reversed;
                    };
            ...
            if (((((_time == _local_7) || (!(_first))) && (!(_arg_3))) && (!(_local_9))))
            {
                return;
            };
            if (!_initted)
            ...
            if (!_active)
            {
                if ((((!(_paused)) && (!(_time === _local_7))) && (_arg_1 > 0)))
                {
                    _active = true;
                };
            };
            ...
            if (_time >= _local_7)
            {
                ...
                while (_local_10)
                {
                    _local_5 = _local_10._next;
                    if (((_paused) && (!(_local_6)))) break;
                    if (((_local_10._active) || (((_local_10._startTime <= _time) && (!(_local_10._paused))) && (!(_local_10._gc)))))
                    {
                        if (!_local_10._reversed)
                        {
                            _local_10.render(((_arg_1 - _local_10._startTime) * _local_10._timeScale), _arg_2, _arg_3);
                        }
                        else
                        {
                            _local_10.render((((_local_10._dirty) ? _local_10.totalDuration() : _local_10._totalDuration) - ((_arg_1 - _local_10._startTime) * _local_10._timeScale)), _arg_2, _arg_3);
                        };
                    };
                    _local_10 = _local_5;
                };
            ...
            else
            {
                ...
                while (_local_10)
                {
                    _local_5 = _local_10._prev;
                    if (((_paused) && (!(_local_6)))) break;
                    if (((_local_10._active) || (((_local_10._startTime <= _local_7) && (!(_local_10._paused))) && (!(_local_10._gc)))))
                    {
                        if (!_local_10._reversed)
                        {
                            _local_10.render(((_arg_1 - _local_10._startTime) * _local_10._timeScale), _arg_2, _arg_3);
            ...
            if (_local_12)
            {
                if (!_gc)
                {
                    if (((_local_4 == _startTime) || (!(_local_11 == _timeScale))))
                    {
                        if (((_time == 0) || (_local_8 >= totalDuration())))
                        {
                            if (_local_13)
                            {
            ...
            while (_local_5)
            {
                if (_local_5._startTime >= _arg_4)
                {
                    ...
                    else
                    {
                        ...
                        if (_arg_1)
                        {
                            _local_6 = _local_6.concat(TimelineLite(_local_5).getChildren(true, _arg_2, _arg_3));
        ...
        public function getTweensOf(_arg_1:Object, _arg_2:Boolean=true):Array
        {
            ...
            _local_4 = TweenLite.getTweensOf(_arg_1);
            _local_6 = _local_4.length;
            while (--_local_6 > -1)
            {
                if (((_local_4[_local_6].timeline === this) || ((_arg_2) && (_contains(_local_4[_local_6])))))
                {
                    _local_3[_local_5++] = _local_4[_local_6];
                };
            };
            if (_local_7)
            {
        ...
        public function shiftChildren(_arg_1:Number, _arg_2:Boolean=false, _arg_3:Number=0):*
        {
            ...
            if (_arg_2)
            {
                for (var _local_4:String in _labels)
                {
                    if (_labels[_local_4] >= _arg_3)
                    {
                        var _local_6:* = _local_4;
                        var _local_7:* = (_labels[_local_6] + _arg_1);
                        _labels[_local_6] = _local_7;
                    };
                };
            };
            _uncache(true);
        ...
        override public function _kill(_arg_1:Object=null, _arg_2:Object=null):Boolean
        {
            ...
            _local_3 = ((_arg_2 == null) ? getChildren(true, true, false) : getTweensOf(_arg_2));
        ...
        override public function totalDuration(_arg_1:Number=NaN):*
        {
            ...
            if (!arguments.length)
            {
                ...
                {
                    _local_5 = 0;
                    var _local_4:Animation = _last;
                    var _local_3:* = Infinity;
                    while (_local_4)
                    {
                        ...
                        if ((((_local_4._startTime > _local_3) && (_sortChildren)) && (!(_local_4._paused))))
                        {
                            add(_local_4, (_local_4._startTime - _local_4._delay));
                        }
                        else
                        {
                            _local_3 = _local_4._startTime;
                        };
                        if (((_local_4._startTime < 0) && (!(_local_4._paused))))
                        {
                            _local_5 = (_local_5 - _local_4._startTime);
                    ...
                    _duration = (_totalDuration = _local_5);
                    _dirty = false;
                };
