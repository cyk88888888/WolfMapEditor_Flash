...
package com.greensock.core
{
    ...
    public class Animation 
    {
        ...
        public function Animation(_arg_1:Number=0, _arg_2:Object=null)
        {
            ...
            if (_rootTimeline == null)
            {
                if (_rootFrame == -1)
                {
                    ...
                    var _local_4:* = true;
                    _rootFramesTimeline._active = _local_4;
                    _rootTimeline._active = _local_4;
        ...
        {
            var _local_1:Number;
            var _local_2:SimpleTimeline = _timeline;
            return ((_local_2 == null) || (((((!(_gc)) && (!(_paused))) && (_local_2.isActive())) && ((_local_1 = _local_2.rawTime()) >= _startTime)) && (_local_1 < (_startTime + (totalDuration() / _timeScale)))));
        }

        public function _enabled(_arg_1:Boolean, _arg_2:Boolean=false):Boolean
        {
            _gc = (!(_arg_1));
            _active = ((((_arg_1) && (!(_paused))) && (_totalTime > 0)) && (_totalTime < _totalDuration));
            if (!_arg_2)
            {
        ...
        public function eventCallback(_arg_1:String, _arg_2:Function=null, _arg_3:Array=null):*
        {
            ...
            if (_arg_1.substr(0, 2) == "on")
            {
                ...
                {
                    vars[_arg_1] = _arg_2;
                    vars[(_arg_1 + "Params")] = (((_arg_3 is Array) && (TweenLite.containsSelf(_arg_3))) ? _swapSelfInParams(_arg_3) : _arg_3);
                };
                if (_arg_1 == "onUpdate")
                {
                    _onUpdate = _arg_2;
        ...
        {
            _dirty = false;
            return ((isNaN(_arg_1)) ? _totalDuration : duration(_arg_1));
        }
        ...
        public function paused(_arg_1:Boolean=false):*
        {
            ...
            if (_arg_1 != _paused)
            {
                if (_timeline)
                {
                    _local_4 = _timeline.rawTime();
                    var _local_3:Number = (_local_4 - _pauseTime);
                    if (((!(_arg_1)) && (_timeline.smoothChildTiming)))
                    {
                        _startTime = (_startTime + _local_3);
                        _uncache(false);
                    };
                    _pauseTime = ((_arg_1) ? _local_4 : NaN);
                    _paused = _arg_1;
                    _active = (((!(_arg_1)) && (_totalTime > 0)) && (_totalTime < _totalDuration));
                    if (((((!(_arg_1)) && (!(_local_3 == 0))) && (_initted)) && (!(duration() === 0))))
                    {
                        render(((_timeline.smoothChildTiming) ? _totalTime : ((_local_4 - _startTime) / _timeScale)), true, true);
                    };
                };
            };
            if (((_gc) && (!(_arg_1))))
